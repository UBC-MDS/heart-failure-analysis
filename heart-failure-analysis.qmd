...
![Cross-validation scores for Logistic Regression-  Logistic regression performs better than Decision tree and KNN on the cross validation data, hence, we will select it as our final model.](figures/lr_cv_scores.png){#lr_cv_scores width=60% fig-pos="H"}
