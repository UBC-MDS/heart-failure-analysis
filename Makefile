...
all: heart_failure_analysis.html heart_failure_analysis.pdf
...
heart_failure_analysis.html: 
	quarto render heart-failure-analysis.qmd --to html  --embed-resources --standalone

# Rule to generate PDF
heart_failure_analysis.pdf: 
